function About() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-gray-100">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-yellow-400 to-red-500 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-5xl font-bold text-black mb-6">About Combat Warrior Taekwon-Do</h1>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-black mb-6">Our Dojang Story</h2>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-yellow-200 to-red-200 rounded-2xl p-8 border-4 border-black">
                <img 
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-black mb-4">The Five Tenets of Taekwon-Do</h2>
            <p className="text-xl text-gray-700">The fundamental principles that guide every ITF practitioner</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            {[
              { title: 'Courtesy', description: 'Respect and politeness towards others', icon: '🙏', color: 'bg-yellow-100 border-yellow-500' },
              { title: 'Integrity', description: 'Honesty and moral uprightness', icon: '💎', color: 'bg-red-100 border-red-500' },
              { title: 'Perseverance', description: 'Persistence in achieving goals', icon: '💪', color: 'bg-yellow-100 border-yellow-500' },
              { title: 'Self-Control', description: 'Discipline over mind and body', icon: '🧘', color: 'bg-red-100 border-red-500' },
              { title: 'Indomitable Spirit', description: 'Unbreakable will and courage', icon: '🔥', color: 'bg-yellow-100 border-yellow-500' }
            ].map((tenet, index) => (
              <div key={index} className={`text-center p-6 rounded-xl ${tenet.color} border-2 hover:shadow-lg transition-all duration-200`}>
                ...
                <p className="text-sm text-gray-800">{tenet.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-red-100 to-yellow-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-black mb-4">Our ITF Certified Instructors</h2>
            <p className="text-xl text-gray-800">Learn from qualified masters trained in authentic ITF curriculum</p>
          </div>
              ...
              <div key={index} className="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow duration-200 border-t-4 border-yellow-500">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-black">{instructor.specialization}</span>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-black mb-4">Tournament Achievements</h2>
            <p className="text-xl text-gray-800">Celebrating our students' success in ITF competitions</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {achievements.map((achievement, index) => (
              <div key={index} className="text-center p-6 rounded-xl bg-gradient-to-br from-yellow-100 to-red-100 hover:from-yellow-200 hover:to-red-200 transition-all duration-200 border-2 border-yellow-500">
      ...
      <section className="py-20 bg-gradient-to-r from-red-600 to-yellow-500">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-black bg-opacity-20 rounded-xl p-8 backdrop-blur-sm border-2 border-white">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg p-6 border-2 border-yellow-500 shadow-lg">
              <h4 className="font-bold text-xl mb-3 text-black">24 ITF Patterns</h4>
              <p className="text-gray-800 font-medium">Complete Tul curriculum from Chon-Ji to Tong-Il</p>
            </div>
            <div className="bg-white rounded-lg p-6 border-2 border-red-500 shadow-lg">
              <h4 className="font-bold text-xl mb-3 text-black">Authentic Techniques</h4>
              <p className="text-gray-800 font-medium">Traditional ITF fundamental movements and applications</p>
            </div>
            <div className="bg-white rounded-lg p-6 border-2 border-yellow-500 shadow-lg">
              <h4 className="font-bold text-xl mb-3 text-black">International Standards</h4>
              <p className="text-gray-800 font-medium">Grading and competition rules as per ITF guidelines</p>
            </div>
          </div>
        </div>
      </section>
